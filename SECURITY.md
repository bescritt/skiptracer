...
- Email the maintainer through a GitHub issue marked "security".

Do not include exploit details in a public issue. We will acknowledge receipt
within a few days and coordinate a fix and disclosure timeline.

## Supported versions

The latest released version (currently 4.0.0) receives security fixes.
